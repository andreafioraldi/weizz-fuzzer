...
static inline void *__zero_malloc(u32 size) {
...
static inline void *__memdup(void *mem, u32 size) {
...
static inline u8 *__memdup_str(u8 *mem, u32 size) {
...
#    define ck_alloc __zero_malloc
#    define ck_alloc_nozero malloc
#    define ck_realloc realloc
#    define ck_realloc_block realloc
#    define ck_strdup strdup
#    define ck_memdup __memdup
#    define ck_memdup_str __memdup_str
#    define ck_free free
